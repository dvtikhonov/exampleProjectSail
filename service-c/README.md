...
| Frontend | Vue 3 SPA + Tailwind CSS (`resources/css/max-app.css`) |
...
| payload `order_{id}_chat` в кнопке `open_app` | `resources/js/max-app/utils/orderChatDeepLink.js` | Deep link в чат заказа из MAX / query `?order_id=&view=chat` |
| `weight` / `weight_unit` в DTO блюда | `resources/js/max-app/utils/dishWeight.js` | Форматирование веса/объёма в UI |
...
│   │   │   └── menu/               # MenuHeader, MenuCategoryTabs, MenuDishGrid, MenuDishCard,
...
│   │   │                           # useMenuCategoryFilter, useClientNavigation, useRestaurantsMenu,
...
│   │                               # orderChatDeepLink.js, dishWeight.js
