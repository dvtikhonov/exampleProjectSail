...
| Меню (админ) | `MenuCategoryAdminService`, `DishAdminService`, `DishAvailabilityScheduleService`, `DishSpreadsheetImportService`, `DishSpreadsheetRowParser`, `DishDefaultImageProvider`, `DishImageUploadService`, `DishImageDeliveryService`, `DishImageUrlResolver` |
...
│   │   │                           # Menu*, Restaurant*, DeliveryTier*, OrderChat*, notifiers
...
│   │   │                           # AdminMenuCategoryDto, Create/UpdateMenuCategoryDto
...
│   │                               # EloquentFoodOrder, EloquentRestaurant, EloquentMenuCategory,
│   │                               # EloquentDeliveryTier, EloquentCustomerCategory, …
...
│   │   │                           # DishSpreadsheetImport*, DishSpreadsheetRowParser, DishDefaultImageProvider,
│   │   │                           # DishImage*, FoodOrderMaxMessageBuilder, LaravelFoodOrder*Notifier,
...
| `2026_07_07_000001` | `is_combo_available` в `max_menu_categories`; индексы lookup для комбо в корзине |
