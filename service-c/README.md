...
| — | `resources/js/max-app/components/menu/MenuComboBuilderSheet.vue` | UI сборки комбо из двух категорий (`is_combo_available`) |
...
| `weight` / `weight_unit` / `weight_unit_label` в DTO | UI админки / карточки блюда | Подпись единицы веса из enum `DishWeightUnit` (отдельного `dishWeight.js` нет) |
...
│   │   │                           # OrderSubmission*, CustomerOrderQuery*, notifiers
...
│   │   │                           # CustomerCategoryDto, DeliveryTierDto, RestaurantSummaryDto
...
│   │   │                           # List/SendOrderMessage, RejectOrderReview
...
│   │   │                           # AdminMenuCategoryList/FormPage, RejectOrderModal
│   │   └── utils/                  # orderStatus.js, orderSnapshotCombo.js, cartGroups.js,
│   │                               # orderChatDeepLink.js
