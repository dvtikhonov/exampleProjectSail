/**
 * Временный скрипт ручной QA для MenuPage (mount через @vue/test-utils).
 * Запуск в контейнере: npm install --no-save @vue/test-utils happy-dom && node scripts/menu-qa-mount.mjs
 */
import { ref } from 'vue';
