...
<template>
    <article
        class="flex flex-col overflow-hidden rounded-[var(--radius-menu-card)] bg-menu-card p-3"
    ...
    >
        ...
        <h3 class="mb-3 line-clamp-2 min-h-[2.5rem] text-sm font-medium leading-tight text-max-text">
            {{ dish.name }}
        </h3>
        ...
        <div class="mt-auto space-y-1.5">
            <button
                ...
                type="button"
                class="flex w-full items-center justify-center rounded-full border border-max-primary bg-white px-3 py-2 text-sm font-medium text-max-primary transition hover:bg-max-primary/10 disabled:cursor-not-allowed disabled:opacity-40"
            ...
            <button
                type="button"
                class="flex w-full items-center justify-center rounded-full bg-max-text px-3 py-2 text-sm font-medium text-white transition hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-40"
            ...
            <button
                ...
                type="button"
                class="w-full text-center text-xs font-medium text-max-primary transition hover:text-max-primary-hover disabled:cursor-not-allowed disabled:opacity-40"
                :disabled="addingComboRef !== null"
