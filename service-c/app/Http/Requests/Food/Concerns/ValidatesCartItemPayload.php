...
/**
 * Общие правила и accessors для добавления позиции в корзину.
 *
 * @mixin FormRequest
 */
trait ValidatesCartItemPayload
{
    /**
     * Правила валидации полей позиции корзины.
     *
     ...
     */
    protected function cartItemWithValidator(Validator $validator): void
    {
