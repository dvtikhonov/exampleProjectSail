...
class FoodOrderCustomerMaxMessageBuilderTest extends TestCase
{
    private FoodOrderCustomerMaxMessageBuilder $builder;
    ...
    protected function setUp(): void
    {
        ...
        $this->builder = $this->app->make(FoodOrderCustomerMaxMessageBuilder::class);
    }
